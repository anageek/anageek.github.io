    ...
    <div className="space-y-8 pb-12 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-zinc-500 text-sm mt-1">Manage core settings and global sections of your portfolio.</p>
        </div>
      </div>
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-zinc-600 mt-2">
                  Use the 'Embed' link format from YouTube (e.g. includes <code className="text-zinc-400">/embed/ID</code>) and preferably append URL parameters like <code className="text-zinc-400">?autoplay=1&mute=1&loop=1</code> for the best hero experience.
                </p>
              </div>
