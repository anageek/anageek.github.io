...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-zinc-950 font-sans p-4 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-500/10 via-zinc-950 to-zinc-950">
      <Card className="w-full max-w-md bg-zinc-900/50 border-zinc-800 backdrop-blur-xl shadow-2xl">
        <CardHeader className="space-y-1">
          <CardTitle className="text-3xl font-bold text-center text-white tracking-tight">Admin Portal</CardTitle>
          <p className="text-zinc-500 text-center text-sm">Entre com suas credenciais para gerenciar o portfólio</p>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-2">
              ...
              {errors.email && <p className="text-[10px] text-red-500 font-bold uppercase tracking-tight ml-1">{errors.email.message}</p>}
            </div>
            <div className="space-y-2">
              <Label htmlFor="password" title="Password" className="text-zinc-400 font-medium text-sm">Senha</Label>
              <div className="relative group">
              ...
              {errors.password && <p className="text-[10px] text-red-500 font-bold uppercase tracking-tight ml-1">{errors.password.message}</p>}
            </div>
            <Button
              type="submit"
              disabled={loading}
        ...
        <CardFooter className="flex flex-col gap-2">
           <p className="text-zinc-600 text-[10px] text-center uppercase tracking-widest font-bold">Arkion Systems &copy; 2024</p>
        </CardFooter>
      </Card>
    </div>
  )
